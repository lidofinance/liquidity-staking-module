...
import (
	...
	wasmd "github.com/iqlusioninc/liquidity-staking-module/app"
...
func NewTestChain(t *testing.T, coord *Coordinator, chainID string, opts ...wasm.Option) *TestChain {
	...
	app := NewTestingAppDecorator(t, wasmd.SetupWithGenesisValSet(t, valSet, []authtypes.GenesisAccount{acc}, balance))
...
func NewTestingAppDecorator(t *testing.T, wasmApp *wasmd.SimApp) *TestingAppDecorator {
	return &TestingAppDecorator{SimApp: wasmApp, t: t}
}
